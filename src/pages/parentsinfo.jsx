    ...
    <div className="parents-whole-container">
      <div className="parentsinfo-container">
        ...
        <p>
          ...
          og unge. <br />
          <br />
          Vi arrangerer Rollespil to gange om måneden i Undallslund.
        </p>
        ...
        <p>
          ...
          ofte giver en hånd med det praktiske og som sørger for kaffe og kakao
          til gamle sjæle i skoven. <br />
          Entusiastiske forældre mødes på facebookgruppen:
        </p>
        <em>
        ...
        <p>
          ...
          sneVind og vejr: eller regn stoppe os. Hvis det regner meget kan vi
          dog godt finde på et slutte tidligere end normalt. I så fald vil vi
          hvis det er muligt annoncere det ved check-in inden spilstart.{" "}
        </p>
        ...
        <p>
          ...
          skoven, men der sker stadig nogle gange ting vi ikke hører om derude.
          Så hvis du får et barn hjem, som har haft en uheldig oplevelse, så
          fortæl os det! Ellers finder vi aldrig ud af det, og selvom der er
          nogle ting vi ikke kan gøre noget ved, så er der også ting vi KAN gøre
          noget ved. Vores mål er at give børnene en god oplevelse og feedback
          fra forældre er derfor uvurderligt. Tøv derfor ikke med at kontakte
          os, også hvis du “bare” har spørgsmål. Du kan finde telefonnumre og
          mail-adresser på foreningens afviklere under Kontakt.
        </p>
